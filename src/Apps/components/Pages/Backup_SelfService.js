...
class SelfService extends Component{
    ...
    //Move Functions...
        ...
        checkBoxA_fitInContainer(newBoxSize){
            ...
            console.log({newBoxSize, a: this.state.boxes.a, b: this.state.boxes.b, wall_a: this.state.wall_a, wall_b: this.state.wall_b, 
                is_contain_width, is_contain_height, is_contain});
